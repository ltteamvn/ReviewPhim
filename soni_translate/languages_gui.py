...
language_data = {
    "english": {
        ...
        # 🧩 **Review Phim supports different TTS (Text-to-Speech) engines, which are:**
        ...
        "cv_url_info": "Automatically download the R.V.C. models from the URL. You can use links from HuggingFace or Drive, and you can include several links, each one separated by a comma. Example: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "spanish": {
        "description": """
        ### 🎥 **¡Traduce videos fácilmente con Review Phim!** 📽️

        Sube un video, audio o proporciona un enlace de YouTube. 📽️ **Obtén el cuaderno actualizado desde el repositorio oficial: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim admite diferentes motores de TTS (Texto a Voz), los cuales son:**
        ...
        "cv_url_info": "Descargue automáticamente los modelos R.V.C. desde la URL. Puede utilizar enlaces de HuggingFace o Drive, e incluso puede incluir varios enlaces, cada uno separado por una coma. Ejemplo: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "french": {
        "description": """
        ### 🎥 **Traduisez facilement les vidéos avec Review Phim !** 📽️

        Téléchargez une vidéo, un fichier audio ou fournissez un lien YouTube. 📽️ **Obtenez le notebook mis à jour à partir du référentiel officiel : [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim prend en charge différents moteurs TTS (Text-to-Speech), à savoir :**
        ...
        "cv_url_info": "Téléchargez automatiquement les modèles R.V.C. depuis l'URL. Vous pouvez utiliser des liens depuis HuggingFace ou Drive, et vous pouvez inclure plusieurs liens, chacun séparé par une virgule. Exemple : https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "german": {
        "description": """
        ### 🎥 **Übersetzen Sie Videos einfach mit Review Phim!** 📽️

        Laden Sie ein Video, eine Audiodatei hoch oder geben Sie einen YouTube-Link an. 📽️ **Holen Sie sich das aktualisierte Notizbuch aus dem offiziellen Repository: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim unterstützt verschiedene TTS (Text-to-Speech)-Engines, darunter:**
        ...
        "cv_url_info": "Laden Sie die R.V.C.-Modelle automatisch von der URL herunter. Sie können Links von HuggingFace oder Drive verwenden und mehrere Links, jeweils durch ein Komma getrennt, einfügen. Beispiel: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "italian": {
        "description": """
        ### 🎥 **Traduci i video facilmente con Review Phim!** 📽️

        Carica un video, un file audio o fornisci un link YouTube. 📽️ **Ottieni il notebook aggiornato dal repository ufficiale: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim supporta diversi motori TTS (Text-to-Speech), tra cui:**
        ...
        "cv_url_info": "Scarica automaticamente i modelli R.V.C. dall'URL. Puoi utilizzare link da HuggingFace o Drive e puoi includere diversi link, ognuno separato da una virgola. Esempio: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "japanese": {
        "description": """
        ### 🎥 **Review Phimで簡単に動画を翻訳しましょう！** 📽️

        動画、音声ファイルをアップロードするか、YouTubeのリンクを提供してください。📽️ **公式リポジトリから最新のノートブックを入手する: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review PhimはさまざまなTTS（テキスト読み上げ）エンジンをサポートしています。これらは次のとおりです:**
        ...
        "cv_url_info": "URLからR.V.C.モデルを自動的にダウンロードします。HuggingFaceまたはドライブからのリンクを使用でき、各リンクをコンマで区切って複数のリンクを含めることができます。例: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "chinese_zh_cn": {
        "description": """
          ### 🎥 **使用Review Phim轻松翻译视频！** 📽️

          上传视频、音频文件或提供YouTube链接。 📽️ **从官方存储库获取更新的笔记本：[Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        "tutorial": """
          ...
          # 🧩 **Review Phim支持不同的TTS（文本到语音）引擎，包括:**
        ...
        "docs_button": "开始语言转换桥",
        "cv_url_info": "从URL自动下载R.V.C.模型。您可以使用HuggingFace或Drive的链接，您可以包括多个链接，每个链接用逗号分隔。示例：https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "ukrainian": {
        "description": """
        ### 🎥 **Перекладайте відео легко з Review Phim!** 📽️

        Завантажте відео, аудіофайл або надайте посилання на YouTube. 📽️ **Отримайте оновлений ноутбук з офіційного репозиторію: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim підтримує різні двигуни TTS (текст-у-мову), які є:**
        ...
        "cv_url_info": "Автоматично завантажте моделі R.V.C. за URL-адресою. Ви можете використовувати посилання з HuggingFace або Drive, а також включати кілька посилань, кожне з яких відокремлене комою. Приклад: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "arabic": {
        "description": """
          ### 🎥 **ترجمة مقاطع الفيديو بسهولة مع Review Phim!** 📽️

          قم بتحميل ملف فيديو أو صوتي أو قدم رابطًا لفيديو YouTube. 📽️ **احصل على الدفتر المحدث من المستودع الرسمي: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        "tutorial": """
          ...
          # 🧩 **يدعم Review Phim محركات TTS (نص إلى كلام) مختلفة، وهي:**
        ...
        "cv_url_info": "قم بتنزيل نماذج R.V.C. تلقائيًا من الرابط. يمكنك استخدام روابط من HuggingFace أو Drive، ويمكنك تضمين عدة روابط، مفصولة بفاصلة. على سبيل المثال: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth، https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "russian": {
        "description": """
        ### 🎥 **Перевод видео легко с Review Phim!** 📽️

        Загрузите видео, аудиофайл или предоставьте ссылку на YouTube. 📽️ **Получите обновленный блокнот из официального репозитория.: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim поддерживает различные движки TTS (текст в речь), которые включают:**
        ...
        "cv_url_info": "Автоматическая загрузка моделей R.V.C. по URL. Можно использовать ссылки из HuggingFace или Drive, и можно включить несколько ссылок, каждую разделенную запятой. Пример: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "turkish": {
        "description": """
        ### 🎥 **Review Phim ile videoları kolayca çevirin!** 📽️

        Bir video yükleyin, ses dosyası ekleyin veya bir YouTube bağlantısı sağlayın. 📽️ **Güncellenmiş notebook'ı resmi depodan alın: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim, farklı TTS (Metin-okuma-sesi) motorlarını destekler, bunlar:**
        ...
        "cv_url_info": "R.V.C. modellerini otomatik olarak URL'den indirin. HuggingFace veya Drive bağlantılarını kullanabilir ve her birini virgülle ayırarak birden çok bağlantı ekleyebilirsiniz. Örnek: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "indonesian": {
        "description": """
        ### 🎥 **Terjemahkan video dengan mudah menggunakan Review Phim!** 📽️

        Unggah video, file audio, atau berikan tautan YouTube. 📽️ **Dapatkan buku catatan yang diperbarui dari repositori resmi: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim mendukung berbagai mesin TTS (Teks-ke-Suara), yaitu:**
        ...
        "cv_url_info": "Unduh model R.V.C. secara otomatis dari URL. Anda dapat menggunakan tautan dari HuggingFace atau Drive, dan Anda dapat menyertakan beberapa tautan, masing-masing dipisahkan oleh koma. Contoh: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "portuguese": {
        "description": """
        ### 🎥 **Traduza vídeos facilmente com o Review Phim!** 📽️

        Carregue um vídeo, arquivo de áudio ou forneça um link do YouTube. 📽️ **Obtenha o caderno atualizado do repositório oficial: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim suporta diferentes motores TTS (Texto para Fala), que são:**
        ...
        "cv_url_info": "Baixe automaticamente os modelos R.V.C. do URL. Você pode usar links do HuggingFace ou Drive, e pode incluir vários links, cada um separado por uma vírgula. Exemplo: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "hindi": {
        "description": """
          ### 🎥 **Review Phim के साथ वीडियो को आसानी से अनुवादित करें!** 📽️

          एक वीडियो, ऑडियो फ़ाइल अपलोड करें या एक YouTube लिंक प्रदान करें। 📽️ **आधिकारिक भंडार से अपडेटेड नोटबुक प्राप्त करें: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        "tutorial": """
          ...
          # 🧩 **Review Phim विभिन्न TTS (टेक्स्ट-टू-स्पीच) इंजनों का समर्थन करता है, जो हैं:**
        ...
        "cv_url_info": "URL से R.V.C. मॉडल आपमूर्त डाउनलोड करें। आप HuggingFace या Drive से लिंक का उपयोग कर सकते हैं, और आप कई लिंक शामिल कर सकते हैं, प्रत्येक को अल्पविराम द्वारा अलग किया जा सकता है। उदाहरण: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "vietnamese": {
        "description": """
        ### 🎥 **Dịch video dễ dàng với Review Phim!** 📽️

        Tải lên một video, tập tin âm thanh hoặc cung cấp một liên kết YouTube. 📽️ **Nhận sổ tay cập nhật từ kho chính thức: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim hỗ trợ các công cụ TTS (Text-to-Speech) khác nhau, bao gồm:**
        ...
        "cv_url_info": "Tự động tải xuống các mô hình R.V.C. từ URL. Bạn có thể sử dụng các liên kết từ HuggingFace hoặc Drive, và bạn có thể bao gồm nhiều liên kết, mỗi liên kết cách nhau bằng dấu phẩy. Ví dụ: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "polish": {
        "description": """
        ### 🎥 **Łatwe tłumaczenie filmów dzięki Review Phim!** 📽️

        Prześlij film, plik dźwiękowy lub podaj link do YouTube. 📽️ **Pobierz aktualny notatnik ze strony oficjalnego repozytorium: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim obsługuje różne silniki TTS (tekst do mowy), które to:**
        ...
        "cv_url_info": "Automatycznie pobierz modele R.V.C. z adresu URL. Możesz użyć linków z HuggingFace lub Drive, i możesz dołączyć kilka linków, każdy oddzielony przecinkiem. Przykład: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "swedish": {
        "description": """
        ### 🎥 **Översätt videor enkelt med Review Phim!** 📽️

        Ladda upp en video, ljudfil eller ange en YouTube-länk. 📽️ **Få den uppdaterade anteckningsboken från det officiella arkivet: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim stöder olika TTS (Text-to-Speech) motorer, vilka är:**
        ...
        "cv_url_info": "Ladda automatiskt ner R.V.C.-modellerna från URL:en. Du kan använda länkar från HuggingFace eller Drive, och du kan inkludera flera länkar, var och en separerad med ett komma. Exempel: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "korean": {
        "description": """
        ### 🎥 **Review Phim를 사용하여 비디오를 쉽게 번역하세요!** 📽️

        비디오, 오디오 파일을 업로드하거나 YouTube 링크를 제공하세요. 📽️ **공식 저장소에서 최신 노트북을 받으세요.: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim는 다양한 TTS (텍스트 음성 변환) 엔진을 지원합니다. 이는 다음과 같습니다:**
        ...
        "cv_url_info": "URL에서 R.V.C. 모델을 자동으로 다운로드합니다. HuggingFace 또는 드라이브에서 링크를 사용할 수 있으며 각각을 쉼표로 구분하여 여러 링크를 포함할 수 있습니다. 예: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "marathi": {
        "description": """
        ### 🎥 **आसानीसोबत Review Phim द्वारे व्हिडिओ अनुवाद करा!** 📽️

        एक व्हिडिओ, ऑडिओ फाईल अपलोड करा किंवा एक YouTube लिंक प्रदान करा. 📽️ **अद्यतनित नोटबुक घ्या आधिकृत भंडारात।: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim विविध TTS (पाठ-टू-स्पीच) इंजिनसाठी समर्थन करते, ज्या म्हणजे:**
    ...
    "azerbaijani": {
        "description": """
        ### 🎥 **Review Phim ilə videoları asanlıqla tərcümə edin!** 📽️

        Video, səs faylı yükləyin və ya YouTube bağlantısı təqdim edin. 📽️ **Review Phim-in rəsmi repositoriyasından yenilənmiş qeydləri alın: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim, fərqli TTS (Mətnə Səsləndirmə) mühərriklərini dəstəkləyir ki, onlar:**
        ...
        "cv_url_info": "R.V.C. modellərini URL-dən avtomatik olaraq yükləyin. HuggingFace və Drive linklərindən istifadə edə bilərsiniz, və hər birini vergül ilə ayrılmış bir neçə link daxil edə bilərsiniz. Misal: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "persian": {
        "description": """
        ### 🎥 **با Review Phim به راحتی ویدئوها را ترجمه کنید!** 📽️

        یک ویدئو، فایل زیرنویس، فایل صوتی را آپلود کنید یا یک لینک ویدئوی URL ارائه دهید. 📽️ **دفترچه یادداشت به‌روز شده را از مخزن رسمی دریافت کنید: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim از موتورهای مختلف TTS (متن به گفتار) پشتیبانی می‌کند، که شامل:**
        ...
        "cv_url_info": "مدل‌های R.V.C. را به صورت خودکار از URL دانلود کنید. می‌توانید از لینک‌های HuggingFace یا Drive استفاده کنید و می‌توانید چندین لینک را شامل کنید، هرکدام با کاما جدا شده باشند. مثال: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
    ...
    "afrikaans": {
        "description": """
        ### 🎥 **Vertaal video's maklik met Review Phim!** 📽️

        Laai 'n video, onderskrif, klanklêer op of verskaf 'n URL-videolink. 📽️ **Kry die opgedateerde notaboek van die amptelike repository: [Review Phim](https://github.com/ltteamvn/ReviewPhim.git)!**
        ...
        # 🧩 **Review Phim ondersteun verskillende TTS (Teks-na-Spraak) enjins, wat is:**
        ...
        "cv_url_info": "Laai outomaties die R.V.C. modelle af van die URL. Jy kan skakels van HuggingFace of Drive gebruik, en jy kan verskeie skakels insluit, elkeen geskei deur 'n komma. Voorbeeld: https://huggingface.co/LTTEAM/VietNamModel/blob/main/damvinhhung/damvinhhung_e170_s6290.pth, https://huggingface.co/LTTEAM/VietNamModel/resolve/main/damvinhhung/damvinhhung.index",
